...
var _user$project$Interpolate$roundTo = F2(
	function (step, interpolate) {
		return function (_p0) {
			return function (c) {
				return step * function (_p1) {
...
var _user$project$Interpolate$linear = F2(
	function (a, b) {
...
var _user$project$Linear$bimap = F4(
...
var _user$project$Linear$clampWith = F6(
	function (mn, mx, a, b, f, x) {
		return (_elm_lang$core$Native_Utils.cmp(x, mn) < 1) ? a : ((_elm_lang$core$Native_Utils.cmp(x, mx) > -1) ? b : f(x));
	});
var _user$project$Linear$deinterpolateClamp = F3(
	function (deinterpolate, a, b) {
		return A5(
			_user$project$Linear$clampWith,
			a,
			b,
			0,
			1,
			A2(deinterpolate, a, b));
	});
var _user$project$Linear$reinterpolateClamp = F3(
	function (reinterpolate, a, b) {
		return A5(
			...
			a,
			b,
			A2(reinterpolate, a, b));
	});
var _user$project$Linear$deinterpolate = F2(
	function (a, b) {
		var delta = b - a;
		return _elm_lang$core$Native_Utils.eq(a, b) ? function (_p10) {
			return delta;
		} : function (x) {
			return (x - a) / delta;
		};
	});
var _user$project$Linear$unscale = F5(
	function (domain, range, clamp, reinterpolate, y) {
		var r = clamp ? _user$project$Linear$reinterpolateClamp(reinterpolate) : reinterpolate;
		return A5(_user$project$Linear$bimap, range, domain, _user$project$Linear$deinterpolate, r, y);
	});
var _user$project$Linear$scale = F6(
	function (domain, range, clamp, deinterpolate, interpolate, x) {
		var d = clamp ? _user$project$Linear$deinterpolateClamp(deinterpolate) : deinterpolate;
		return A5(_user$project$Linear$bimap, domain, range, d, interpolate, x);
	});

var _user$project$Ticks$e2 = _elm_lang$core$Basics$sqrt(2.0);
var _user$project$Ticks$e5 = _elm_lang$core$Basics$sqrt(10.0);
var _user$project$Ticks$e10 = _elm_lang$core$Basics$sqrt(50.0);
var _user$project$Ticks$log10 = _elm_lang$core$Basics$logBase(10.0);
var _user$project$Ticks$ln10 = A2(_elm_lang$core$Basics$logBase, _elm_lang$core$Basics$e, 10.0);
var _user$project$Ticks$tickIncrement = F3(
	function (start, stop, count) {
		var n = _elm_lang$core$Basics$toFloat(count);
		var step = (stop - start) / A2(_elm_lang$core$Basics$max, 0, n);
		var power = _elm_lang$core$Basics$toFloat(
			_elm_lang$core$Basics$floor(
				_user$project$Ticks$log10(step)));
		var error = step / Math.pow(10, power);
		var m = (_elm_lang$core$Native_Utils.cmp(error, _user$project$Ticks$e10) > -1) ? 10 : ((_elm_lang$core$Native_Utils.cmp(error, _user$project$Ticks$e5) > -1) ? 5 : ((_elm_lang$core$Native_Utils.cmp(error, _user$project$Ticks$e2) > -1) ? 2 : 1));
		return (_elm_lang$core$Native_Utils.cmp(power, 0) > -1) ? (m * Math.pow(10, power)) : ((0 - Math.pow(10, 0 - power)) / m);
	});
var _user$project$Ticks$ticks = F3(
	function (start, stop, count) {
		var step = A3(_user$project$Ticks$tickIncrement, start, stop, count);
		var reverse = (_elm_lang$core$Native_Utils.cmp(stop, start) < 0) ? _elm_lang$core$List$reverse : _elm_lang$core$Basics$identity;
		if (_elm_lang$core$Native_Utils.eq(step, 0.0) || _elm_lang$core$Basics$isInfinite(step)) {
			return {ctor: '[]'};
		} else {
			if (_elm_lang$core$Native_Utils.cmp(step, 0.0) > 0) {
				var newStop = _elm_lang$core$Basics$floor(stop / step);
				var newStart = _elm_lang$core$Basics$ceiling(start / stop);
				var n = (newStop - newStart) + 1;
				return reverse(
					A2(
						_elm_lang$core$List$map,
						function (i) {
							return _elm_lang$core$Basics$toFloat(newStart + i) * step;
						},
						A2(_elm_lang$core$List$range, 0, n - 1)));
			} else {
				var newStop = _elm_lang$core$Basics$ceiling(stop * step);
				var newStart = _elm_lang$core$Basics$floor(start * step);
				var n = (newStart - newStop) + 1;
				return reverse(
					A2(
						_elm_lang$core$List$map,
						function (i) {
...
var _user$project$RangeSlider$absolutePosition = F5(
	function (unscale, clampToRange, start, current, offsetX) {
		return clampToRange(
			unscale(
				(offsetX + _elm_lang$core$Basics$toFloat(current.x)) - _elm_lang$core$Basics$toFloat(start.x)));
	});
var _user$project$RangeSlider$maybe = F3(
	function (whenNothing, withJust, maybeVal) {
		var _p0 = maybeVal;
		if (_p0.ctor === 'Just') {
			return withJust(_p0._0);
		} else {
			return whenNothing;
		}
	});
var _user$project$RangeSlider$mkPx = function (px) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_elm_lang$core$Basics$toString(px),
		'px');
};
var _user$project$RangeSlider$viewTick = F3(
	function (scale, format, tick) {
		var left = A2(
			_elm_lang$core$Basics_ops['++'],
			_elm_lang$core$Basics$toString(
				scale(tick)),
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('slider-label'),
				_1: {
					ctor: '::',
...
var _user$project$RangeSlider$Drag = F2(
	function (a, b) {
		return {start: a, current: b};
	});
var _user$project$RangeSlider$State = function (a) {
	return {ctor: 'State', _0: a};
};
var _user$project$RangeSlider$initialState = _user$project$RangeSlider$State(_elm_lang$core$Maybe$Nothing);
var _user$project$RangeSlider$update = F4(
	function (_p3, msg, _p2, _p1) {
		var _p4 = _p3;
		var _p20 = _p4._0;
		var _p5 = _p2;
		var _p19 = _p5._0;
		...
		switch (_p7.ctor) {
			case 'DragStart':
				...
				var ux = function () {
					var _p8 = _p9;
					if (_p8.ctor === 'Upper') {
						return _p20.scale(_p18);
					} else {
						return _p20.scale(_p17);
					}
				}();
				return {
					ctor: '_Tuple2',
					_0: _user$project$RangeSlider$State(
						_elm_lang$core$Maybe$Just(
							{
								ctor: '_Tuple3',
								_0: _p9,
								_1: A2(_user$project$RangeSlider$Drag, _p10, _p10),
								_2: ux
							})),
			...
			case 'DragAt':
				...
				return {
					ctor: '_Tuple2',
					_0: _user$project$RangeSlider$State(newState),
					_1: _elm_lang$core$Maybe$Nothing
				};
			default:
				var _p13 = _p19;
				if ((_p13.ctor === 'Just') && (_p13._0.ctor === '_Tuple3')) {
					...
					var _p14 = function () {
						...
						if (_p15.ctor === 'Lower') {
							return {
								ctor: '_Tuple2',
								_0: _elm_lang$core$Tuple$first(_p20.domain),
								_1: _p18
							};
						} else {
							return {
								ctor: '_Tuple2',
								_0: _p17,
								_1: _elm_lang$core$Tuple$second(_p20.domain)
							};
						}
					}();
					var l = _p14._0;
					var u = _p14._1;
					var newValue = A5(
						_user$project$RangeSlider$absolutePosition,
						_p20.unscale,
						A2(_elm_lang$core$Basics$clamp, l, u),
						_p13._0._1.start,
						_p7._0,
						_p13._0._2);
					return {
						ctor: '_Tuple2',
						_0: _user$project$RangeSlider$State(_elm_lang$core$Maybe$Nothing),
						_1: A2(_p20.toMsg, _p16, newValue)
					};
				} else {
					return {
						ctor: '_Tuple2',
...
var _user$project$RangeSlider$Lower = {ctor: 'Lower'};
var _user$project$RangeSlider$Upper = {ctor: 'Upper'};
var _user$project$RangeSlider$DragEnd = function (a) {
	return {ctor: 'DragEnd', _0: a};
};
var _user$project$RangeSlider$DragAt = function (a) {
	return {ctor: 'DragAt', _0: a};
};
var _user$project$RangeSlider$subscriptions = function (_p21) {
	var _p22 = _p21;
	var _p23 = _p22._0;
	if (_p23.ctor === 'Nothing') {
		...
		return _elm_lang$core$Platform_Sub$batch(
			{
				ctor: '::',
				_0: _elm_lang$mouse$Mouse$moves(_user$project$RangeSlider$DragAt),
				_1: {
					ctor: '::',
					_0: _elm_lang$mouse$Mouse$ups(_user$project$RangeSlider$DragEnd),
					_1: {ctor: '[]'}
				}
			});
	}
};
var _user$project$RangeSlider$DragStart = F2(
	function (a, b) {
		return {ctor: 'DragStart', _0: a, _1: b};
	});
var _user$project$RangeSlider$onMouseDown = function (endpoint) {
	return A2(
		_elm_lang$html$Html_Events$on,
		'mousedown',
		A2(
			_elm_lang$core$Json_Decode$map,
			_user$project$RangeSlider$DragStart(endpoint),
			_elm_lang$mouse$Mouse$position));
};
var _user$project$RangeSlider$viewSliderHandle = F4(
	function (endpoint, left, attrs, content) {
		return A2(
			_elm_lang$html$Html$span,
			{
				ctor: '::',
				_0: _user$project$RangeSlider$onMouseDown(endpoint),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('slider-handle'),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$style(
							{
			...
			{
				ctor: '::',
				_0: A2(_elm_lang$html$Html$span, attrs, content),
				_1: {ctor: '[]'}
			});
	});
var _user$project$RangeSlider$view = F3(
	function (_p26, _p25, _p24) {
		var _p27 = _p26;
		var _p36 = _p27._0;
		var _p28 = _p25;
		var _p29 = _p24;
		var _p35 = _p29._1;
		var _p34 = _p29._0;
		var sliderWidth = _user$project$RangeSlider$mkPx(
			_elm_lang$core$Tuple$second(_p36.range) - _elm_lang$core$Tuple$first(_p36.range));
		var _p30 = function () {
			var _p31 = _p28._0;
			if ((_p31.ctor === 'Just') && (_p31._0.ctor === '_Tuple3')) {
				if (_p31._0._0.ctor === 'Lower') {
					var clampIt = A2(
						_elm_lang$core$Basics$clamp,
						_elm_lang$core$Tuple$first(_p36.domain),
						_p35);
					return {
						ctor: '_Tuple2',
						_0: A5(_user$project$RangeSlider$absolutePosition, _p36.unscale, clampIt, _p31._0._1.start, _p31._0._1.current, _p31._0._2),
						_1: _p35
					};
				} else {
					var clampIt = A2(
						_elm_lang$core$Basics$clamp,
						_p34,
						_elm_lang$core$Tuple$second(_p36.domain));
					return {
						ctor: '_Tuple2',
						_0: _p34,
						_1: A5(_user$project$RangeSlider$absolutePosition, _p36.unscale, clampIt, _p31._0._1.start, _p31._0._1.current, _p31._0._2)
					};
				}
			} else {
				return {ctor: '_Tuple2', _0: _p34, _1: _p35};
			}
		}();
		var tempLower = _p30._0;
		var tempUpper = _p30._1;
		var _p32 = {
			ctor: '_Tuple2',
			_0: _p36.scale(tempLower),
			_1: _p36.scale(tempUpper)
		};
		var positionLower = _p32._0;
		var positionUpper = _p32._1;
		var progressWidth = _user$project$RangeSlider$mkPx(positionUpper - positionLower);
		var _p33 = {
			ctor: '_Tuple2',
			_0: _user$project$RangeSlider$mkPx(positionLower),
			_1: _user$project$RangeSlider$mkPx(positionUpper)
		};
		var lowerLeft = _p33._0;
		var upperLeft = _p33._1;
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('range-slider'),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$style(
							{
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'width', _1: sliderWidth},
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('slider-track'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$style(
								{
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('slider-progress'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$style(
									{
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 'left', _1: lowerLeft},
										_1: {
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'width', _1: progressWidth},
											_1: {ctor: '[]'}
										}
									}),
								_1: {ctor: '[]'}
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('slider-axis'),
								_1: {ctor: '[]'}
							},
							A2(
								_elm_lang$core$List$map,
								A2(_user$project$RangeSlider$viewTick, _p36.scale, _p36.format),
								_p36.ticks)),
						_1: {
							ctor: '::',
							_0: A4(
								_user$project$RangeSlider$viewSliderHandle,
								_user$project$RangeSlider$Lower,
								lowerLeft,
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('slider-label'),
							...
							_1: {
								...
								_0: A4(
									_user$project$RangeSlider$viewSliderHandle,
									_user$project$RangeSlider$Upper,
									upperLeft,
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('slider-label'),
...
var _user$project$RangeSlider$onTouch = function (endpoint) {
	return A2(
		_elm_lang$html$Html_Events$on,
		'touchstart',
		A2(
...
var _user$project$RangeSlider$Config = function (a) {
	return {ctor: 'Config', _0: a};
};
var _user$project$RangeSlider$config = function (_p37) {
	var _p38 = _p37;
	return _user$project$RangeSlider$Config(
		{domain: _p38.domain, range: _p38.range, scale: _p38.scale, unscale: _p38.unscale, ticks: _p38.ticks, format: _p38.format, toMsg: _p38.toMsg});
};
var _user$project$RangeSlider$simpleConfig = function (_p39) {
	var _p40 = _p39;
	var _p43 = _p40.domain;
	var _p41 = _p43;
	var d0 = _p41._0;
	var d1 = _p41._1;
	var range = {ctor: '_Tuple2', _0: 0.0, _1: _p40.width};
	var ticks = A3(
		_user$project$RangeSlider$maybe,
		{ctor: '[]'},
		A2(_user$project$Ticks$ticks, d0, d1),
		_p40.maybeTickCount);
	var unscale = A4(
		_user$project$Linear$unscale,
		_p43,
		range,
		true,
		function () {
			var _p42 = _p40.maybeRoundTo;
			if (_p42.ctor === 'Just') {
				return F2(
					function (a, b) {
						return A2(
							_user$project$Interpolate$roundTo,
							_p42._0,
							A2(_user$project$Interpolate$linear, a, b));
					});
			} else {
				return _user$project$Interpolate$linear;
			}
		}());
	var scale = A5(_user$project$Linear$scale, _p43, range, true, _user$project$Linear$deinterpolate, _user$project$Interpolate$linear);
	return _user$project$RangeSlider$Config(
		{domain: _p43, range: range, scale: scale, unscale: unscale, ticks: ticks, format: _p40.format, toMsg: _p40.toMsg});
};

var _user$project$Main$reinterpolateLog = F2(
	function (a, b) {
		return (_elm_lang$core$Native_Utils.cmp(a, 0.0) < 0) ? function (t) {
			return 0 - (Math.pow(0 - b, t) * Math.pow(0 - a, 1 - t));
		} : function (t) {
...
var _user$project$Main$log10 = _elm_lang$core$Basics$logBase(10);
var _user$project$Main$deinterpolateLog = F2(
	function (a, b) {
		var delta = _user$project$Main$log10(b / a);
		return _elm_lang$core$Native_Utils.eq(delta, 0.0) ? _elm_lang$core$Basics$always(delta) : function (x) {
			return _user$project$Main$log10(x / a) / delta;
		};
	});
var _user$project$Main$bimap = F4(
	function (_p1, _p0, deinterpolate, reinterpolate) {
		var _p2 = _p1;
		var _p9 = _p2._1;
		var _p8 = _p2._0;
...
var _user$project$Main$clampWith = F6(
	function (mn, mx, a, b, f, x) {
		return (_elm_lang$core$Native_Utils.cmp(x, mn) < 1) ? a : ((_elm_lang$core$Native_Utils.cmp(x, mx) > -1) ? b : f(x));
	});
var _user$project$Main$deinterpolateClamp = F3(
	function (deinterpolate, a, b) {
		return A5(
			_user$project$Main$clampWith,
			a,
			b,
			0,
			1,
...
var _user$project$Main$scale = F6(
	function (domain, range, clamp, deinterpolate, interpolate, x) {
		var d = clamp ? _user$project$Main$deinterpolateClamp(deinterpolate) : deinterpolate;
		return A5(_user$project$Main$bimap, domain, range, d, interpolate, x);
	});
var _user$project$Main$reinterpolateClamp = F3(
	function (reinterpolate, a, b) {
		return A5(
			_user$project$Main$clampWith,
			0,
...
var _user$project$Main$interpolateRoundTo = F2(
	function (step, interpolate) {
		return function (_p10) {
			return function (x) {
				return step * _elm_lang$core$Basics$toFloat(
					_elm_lang$core$Basics$round(x / step));
			}(
				interpolate(_p10));
		};
	});
var _user$project$Main$deinterpolateLinear = F2(
	function (a, b) {
		if (_elm_lang$core$Native_Utils.eq(a, b)) {
			return _elm_lang$core$Basics$always(b - a);
		} else {
			var delta = b - a;
			return function (x) {
				return (x - a) / delta;
...
var _user$project$Main$unscale = F5(
	function (domain, range, clamp, reinterpolate, y) {
		var r = clamp ? _user$project$Main$reinterpolateClamp(reinterpolate) : reinterpolate;
		return A5(_user$project$Main$bimap, range, domain, _user$project$Main$deinterpolateLinear, r, y);
	});
var _user$project$Main$interpolateLinear = F2(
	function (a, b) {
		var delta = b - a;
		return function (t) {
			return a + (delta * t);
...
var _user$project$Main$logUnscale = F3(
	function (domain, width, roundTo) {
		return A4(
			_user$project$Main$unscale,
			domain,
			{ctor: '_Tuple2', _0: 0.0, _1: width},
			true,
			function () {
				var _p11 = roundTo;
				if (_p11.ctor === 'Just') {
					return F2(
						function (a, b) {
							return A2(
								_user$project$Main$interpolateRoundTo,
								_p11._0,
								A2(_user$project$Main$reinterpolateLog, a, b));
						});
				} else {
					return _user$project$Main$reinterpolateLog;
				}
			}());
	});
var _user$project$Main$logScale = F2(
	function (domain, width) {
		return A5(
			_user$project$Main$scale,
			domain,
			{ctor: '_Tuple2', _0: 0.0, _1: width},
			true,
			_user$project$Main$deinterpolateLog,
			_user$project$Main$interpolateLinear);
	});
var _user$project$Main$init = A2(
	_elm_lang$core$Platform_Cmd_ops['!'],
	{
		linearRangeSliderState: _user$project$RangeSlider$initialState,
		currentLinearRange: {ctor: '_Tuple2', _0: 10.0, _1: 50.0},
		logRangeSliderState: _user$project$RangeSlider$initialState,
		currentLogRange: {ctor: '_Tuple2', _0: 100000.0, _1: 400000.0}
	},
	{ctor: '[]'});
var _user$project$Main$Model = F4(
	function (a, b, c, d) {
		return {currentLinearRange: a, currentLogRange: b, linearRangeSliderState: c, logRangeSliderState: d};
	});
var _user$project$Main$Log = {ctor: 'Log'};
var _user$project$Main$Linear = {ctor: 'Linear'};
var _user$project$Main$NoOp = {ctor: 'NoOp'};
var _user$project$Main$RangeMsg = F2(
	function (a, b) {
		return {ctor: 'RangeMsg', _0: a, _1: b};
	});
	...
	return _elm_lang$core$Platform_Sub$batch(
		{
			...
			_0: A2(
				_elm_lang$core$Platform_Sub$map,
				_user$project$Main$RangeMsg(_user$project$Main$Linear),
				_user$project$RangeSlider$subscriptions(model.linearRangeSliderState)),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$core$Platform_Sub$map,
					_user$project$Main$RangeMsg(_user$project$Main$Log),
					_user$project$RangeSlider$subscriptions(model.logRangeSliderState)),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Main$viewRange = F4(
	function (which, config, state, currentRange) {
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('flex-item'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: A2(
									...
									_user$project$Main$RangeMsg(which),
									A3(_user$project$RangeSlider$view, config, state, currentRange)),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}),
...
var _user$project$Main$UpdateRange = F3(
	function (a, b, c) {
		return {ctor: 'UpdateRange', _0: a, _1: b, _2: c};
	});
var _user$project$Main$linearRangeConfig = _user$project$RangeSlider$simpleConfig(
	{
		domain: {ctor: '_Tuple2', _0: 0.0, _1: 100.0},
		width: 300.0,
		maybeTickCount: _elm_lang$core$Maybe$Just(5),
		format: _elm_lang$core$Basics$toString,
		maybeRoundTo: _elm_lang$core$Maybe$Just(5),
		toMsg: F2(
			function (endpoint, val) {
				return _elm_lang$core$Maybe$Just(
					A3(_user$project$Main$UpdateRange, _user$project$Main$Linear, endpoint, val));
			})
	});
var _user$project$Main$logRangeConfig = function () {
	var isRound = function (x) {
		return _elm_lang$core$Native_Utils.cmp(
	...
	var format = function (x) {
		var p = A2(_elm_lang$core$Basics$logBase, 10, x);
		return isRound(p) ? A2(
			_elm_lang$core$Basics_ops['++'],
			'10e',
			_elm_lang$core$Basics$toString(
				_elm_lang$core$Basics$round(p))) : _elm_lang$core$Basics$toString(x);
	};
	var ticks = {
		ctor: '::',
		_0: 10000,
	...
	var width = 300.0;
	var range = {ctor: '_Tuple2', _0: 0.0, _1: width};
	var domain = {ctor: '_Tuple2', _0: 10000.0, _1: 1000000.0};
	var scale = A2(_user$project$Main$logScale, domain, width);
	var unscale = A3(
		_user$project$Main$logUnscale,
		domain,
		width,
		_elm_lang$core$Maybe$Just(10000));
	return _user$project$RangeSlider$config(
		{
			domain: domain,
			range: range,
			...
			toMsg: F2(
				function (endpoint, val) {
					return _elm_lang$core$Maybe$Just(
						A3(_user$project$Main$UpdateRange, _user$project$Main$Log, endpoint, val));
				})
		});
}();
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		while (true) {
			...
			switch (_p12.ctor) {
				case 'UpdateRange':
					if (_p12._0.ctor === 'Linear') {
						var _p15 = _p12._2;
						var _p13 = model.currentLinearRange;
						var oldLower = _p13._0;
						var oldUpper = _p13._1;
						var newRange = function () {
							var _p14 = _p12._1;
							if (_p14.ctor === 'Lower') {
								return {ctor: '_Tuple2', _0: _p15, _1: oldUpper};
							} else {
								return {ctor: '_Tuple2', _0: oldLower, _1: _p15};
							}
						}();
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							_elm_lang$core$Native_Utils.update(
								model,
								{currentLinearRange: newRange}),
							{ctor: '[]'});
					} else {
						var _p18 = _p12._2;
						var _p16 = model.currentLogRange;
						var oldLower = _p16._0;
						var oldUpper = _p16._1;
						var newRange = function () {
							var _p17 = _p12._1;
							if (_p17.ctor === 'Lower') {
								return {ctor: '_Tuple2', _0: _p18, _1: oldUpper};
							} else {
								return {ctor: '_Tuple2', _0: oldLower, _1: _p18};
							}
						}();
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							_elm_lang$core$Native_Utils.update(
								model,
								{currentLogRange: newRange}),
							{ctor: '[]'});
					}
				case 'RangeMsg':
					if (_p12._0.ctor === 'Linear') {
						var _p19 = A4(_user$project$RangeSlider$update, _user$project$Main$linearRangeConfig, _p12._1, model.linearRangeSliderState, model.currentLinearRange);
						var newState = _p19._0;
						var maybeMsg = _p19._1;
						var newModel = _elm_lang$core$Native_Utils.update(
							model,
							{linearRangeSliderState: newState});
						var _p20 = maybeMsg;
						if (_p20.ctor === 'Just') {
							var _v7 = _p20._0,
								_v8 = newModel;
						...
						var _p21 = A4(_user$project$RangeSlider$update, _user$project$Main$logRangeConfig, _p12._1, model.logRangeSliderState, model.currentLogRange);
						var newState = _p21._0;
						var maybeMsg = _p21._1;
						var newModel = _elm_lang$core$Native_Utils.update(
							model,
							{logRangeSliderState: newState});
						var _p22 = maybeMsg;
						if (_p22.ctor === 'Just') {
							var _v10 = _p22._0,
								_v11 = newModel;
...
var _user$project$Main$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('flex-container'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A4(_user$project$Main$viewRange, _user$project$Main$Linear, _user$project$Main$linearRangeConfig, model.linearRangeSliderState, model.currentLinearRange),
			_1: {
				ctor: '::',
				_0: A4(_user$project$Main$viewRange, _user$project$Main$Log, _user$project$Main$logRangeConfig, model.logRangeSliderState, model.currentLogRange),
				_1: {ctor: '[]'}
			}
		});
};
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"RangeSlider.Msg":{"args":[],"tags":{"DragEnd":["Mouse.Position"],"DragAt":["Mouse.Position"],"DragStart":["RangeSlider.Endpoint","Mouse.Position"]}},"Main.Msg":{"args":[],"tags":{"UpdateRange":["Main.WhichRange","RangeSlider.Endpoint","Float"],"RangeMsg":["Main.WhichRange","RangeSlider.Msg"],"NoOp":[]}},"RangeSlider.Endpoint":{"args":[],"tags":{"Upper":[],"Lower":[]}},"Main.WhichRange":{"args":[],"tags":{"Log":[],"Linear":[]}}},"aliases":{"Mouse.Position":{"args":[],"type":"{ x : Int, y : Int }"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
